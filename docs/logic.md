...
- `Динамика среднего score` is now built over the whole available period, while the compact recognition/tokens/minutes charts remain limited to the latest 7 days.

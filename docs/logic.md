...
- Dashboard also includes a scenario-level `tokens per minute` bar chart and places the two token-focused monthly line charts into a dedicated row immediately after the 6-month heatmap.
